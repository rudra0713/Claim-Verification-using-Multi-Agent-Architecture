...
executor_agent_system_message = '''Given the action plan, execute it with a clear explanation. Return the final verdict as a single word on a new line: "support", "refute", or "not verifiable info". Ensure your final message ends with this standalone keyword to terminate the chat. Example:
<explanation>
support
'''
